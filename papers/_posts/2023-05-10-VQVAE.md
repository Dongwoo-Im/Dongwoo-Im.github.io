...
또한, VQ-VAE에서는 ELBO의 regularization term인 KLD가 상수값이 되기 때문에 posterior collapse 문제로부터 자유로워집니다. VAE의 variational inference를 적용한 approximate posterior가 간단히 VQ로 대체된다고 생각하셔도 될 것 같습니다.
...
> 압축률 : $\frac{128*128*3*8}{32*32*1*9} \approx$ 42.6
