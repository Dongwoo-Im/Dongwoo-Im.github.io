...
위 식에서 $\beta$는 [beta-VAE](https://arxiv.org/abs/1804.03599)에서 도입된 것으로, $\beta$를 통해 reconstruction과 latent code의 disentanglement를 조절할 수 있습니다. $\beta$가 커질수록, latent code가 disentangle 될 수 있다고 하네요.
